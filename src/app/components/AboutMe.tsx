    ...
    return (
        <section className="bg-white">
            <div className="grid grid-row-1 grid-cols-2 gap-4">
                ...
                <div className='content-around m-14 align-center'>
                    <h2 className="flex justify-left text-black font-semibold text-4xl italic text-center pb-10">My Cloud Journey</h2>
